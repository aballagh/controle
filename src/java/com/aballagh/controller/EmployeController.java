package com.aballagh.controller;

import com.aballagh.entity.Employe;
import com.aballagh.controller.util.JsfUtil;
import com.aballagh.controller.util.JsfUtil.PersistAction;
import com.aballagh.services.EmployeFacade;
...
public class EmployeController implements Serializable {
    ...
    // Method to filter the items based on the filterValue
    public List<Employe> getFilteredItems() {
        ...
        if (filterValue == null || filterValue.trim().isEmpty()) {
            ...
            // Otherwise, filter the list based on the filterValue
            for (Employe employe : items) {
                if (employe.getNom().toLowerCase().contains(filterValue.toLowerCase())) {
